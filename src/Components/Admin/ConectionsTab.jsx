...
import { Link as LinkIcon, Search, MapPin, CheckCircle, Clock, AlertTriangle, ShieldCheck, Eye } from 'lucide-react';
import { Pagination } from './Pagination';

export const ConnectionsTab = ({ connsFilter, setConnsFilter, filteredConns, pagedConns, pageConns, setPageConns, ITEMS_PER_PAGE, setViewingConnection, safeDateStr }) => (
